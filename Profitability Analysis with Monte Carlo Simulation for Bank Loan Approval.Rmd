...
![Table 1: Comparison of Residential and Commercial Projects](table1.png){width=50%}{height=50%}
...
![Table 2: Office Building Development Historical Data](table2.png){width=50%}{height=50%}
